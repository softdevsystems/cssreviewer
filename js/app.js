(() => {
  ...
  function renderAbout(){
    setPage('About','Credits and information about SoftDev Systems.');
      ...
      <section class="about-page">
        <section class="about-hero-card panel">
          <div class="about-hero-copy">
            ...
            <div class="about-trainer-inline">
              <span>Trainer</span>
              <b>Advent Grace Montesa-Bracino</b>
            </div>
          </div>
  ...
  $('#menuBtn').onclick=()=>{$('#sidebar').classList.add('open');$('#sidebarBackdrop').classList.add('show');};const sidebarClose=$('#sidebarClose');if(sidebarClose)sidebarClose.onclick=closeSidebar;$('#sidebarBackdrop').onclick=closeSidebar;
